...
t2 .to(".figAyuda",{duration:1.2, rotation:135,x:300})
...
figuras["BigTriangle1"] = ["BigTriangleNull1",135];
figuras["BigTriangle2"] = ["BigTriangleNull2",-135] ;
figuras["MediumTriangle"] = ["MediumTriangleNull",45];
figuras["SmallTriangle1"] = ["SmallTriangleNull1",80];
figuras["SmallTriangle2"] = ["SmallTriangleNull2",135];
...
document.getElementById("boton").addEventListener("click",()=>{ //activa una funcion tras precionar el boton 
   if(bandera_ayuda==1){
      ...
      tl.to(".figNull",{duration:0, fill:"#44627e"}); //todas las figuras inamovibles regresan a tener su color principal
