...
t2.to(".figAyuda",{duration:1, rotation:45})
...
figuras["BigTriangle1"] = ["BigTriangleNull1",180];
figuras["BigTriangle2"] = ["BigTriangleNull2",-90] ;
figuras["MediumTriangle"] = ["MediumTriangleNull",45];
figuras["SmallTriangle1"] = ["SmallTriangleNull1",-135];
figuras["SmallTriangle2"] = ["SmallTriangleNull2",45];
figuras["Square"] = ["SquareNull",45];
figuras["Rombo"] = ["RomboNull",-45];
