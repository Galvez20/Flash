...
t2 .to(".figAyuda",{duration:0.8, rotation:-45})
    .to(".figAyuda",{duration:1, x:352, y:-33});

t2.pause();

tl.to("#pelota",{duration:0, opacity:0, scale:0})
...
figuras["SmallTriangle1"] = ["SmallTriangleNull2",0];
figuras["SmallTriangle2"] = ["SmallTriangleNull1",0];
...
function ganar(){  //Funcion que es llamada para compara si las figuras ya estan en su lugar
    ...
    tl.to("#pelota",{duration: 0, opacity:1, scale:1})
    .to("#pelota",{duration: 0.6, ease: "none",x:300})
    .to("#pelota",{duration: 0.8, ease: "none",x:-200, y:-300})
