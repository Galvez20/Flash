...
t2 .to(".figAyuda",{duration:1.2,  y:-91})
...
figuras["SmallTriangle1"] = ["SmallTriangle1Null",0];
figuras["SmallTriangle2"] = ["SmallTriangle2Null",0];
figuras["SmallTriangle3"] = ["SmallTriangle3Null",0];
figuras["SmallTriangle4"] = ["SmallTriangle4Null",-135];
figuras["BigTriangle1"] = ["BigTriangle1Null",0];
figuras["BigTriangle2"] = ["BigTriangle2Null",0];
figuras["Square"] = ["SquareNull",65];
