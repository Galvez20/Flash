...
t2 .to(".figAyuda",{duration:1.2, x:242})
...
figuras["TriangleRed1"] = "TriangleRed1Null";
figuras["TrianglePink"] = "TrianglePinkNull";
figuras["TriangleRed2"] = "TrianglePinkNull";
figuras["TriangleGreen1"] = "TriangleGreen1Null";
figuras["TriangleGreen2"] = "TriangleGreen2Null";
figuras["Square"] = "SquareNull";
figuras["Rombo"] = "RomboNull";
...
Draggable.create( ".fig", {                //Asignamos la clase de las fichas para movelos         
   ...
   onPress:function(e){                  //funcion que es llamada tras detecta un click del mouse a la figura
      ...
      gsap.to(this.target,{duration:0, rotation:figuras[figurasId] });     //rotamos la figura
  },                
  onRelease:function(e){   // funcion que es llamada cuando el mouse deja de precionar el elemento s
      if (this.hitTest("#" + figuras[figurasId], overlapThreshold)){  //si detecta que esta sobre su espacio correspondiente
         tl.to(this.target, {duration: 0, opacity:0, scale:0}); //borra el triangulo grande Amarillo
         tl.to("#" + figuras[figurasId], {duration: 0, fill: color}); //la figura cambiara de colo
...
document.getElementById("boton").addEventListener("click",()=>{ //activa una funcion tras precionar el boton 
  if(bandera_ayuda==1){
    ...
    gsap.to(".figAyuda",{duration:0, x:0, y:0, opacity:1, scale:1}) //la figura de ayuda (la que se mueve sola) comienza su reccorio
